...
class ModelArguments:
    ...
    unfreeze_encoder: bool = field(
        default=False, metadata={"help": "Whether to unfreeze the wav2vec encoder for training."}
    )
    freeze_embeds: bool = field(
        default=False, metadata={"help": "Whether  to freeze the embeddings or conv feature extractor for wav2vec2."}
    )
    freeze_model: bool = field(
        default=False, metadata={"help": "Whether  to freeze the model."}
    )
    freeze_model_but_classifier_head: bool = field(
        default=False,
        metadata={
            "help": "Whether to freeze the"
            "whole model and only keep the classifier head head as the training parameter."
        },
    )
...
class DataTrainingArguments:
    ...
    tasks: Optional[List[str]] = field(
        default="auto",
        metadata={
            "help": "List of training task name and configuration mappings as dictionary."
        },
    )
    eval_tasks: Optional[List[str]] = field(
        default="auto",
        metadata={
            "help": "List of evaluation task name and configuration mappings as dictionary."
        },
    )
    test_tasks: Optional[List[str]] = field(
        default="auto",
        metadata={
            "help": "List of evaluation task name and configuration mappings as dictionary."
        },
